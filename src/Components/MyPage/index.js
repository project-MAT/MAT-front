...
import "./style.css";
import MyItem from "../Common/FixBkx";
...
const MyPage = () => {
    ...
    return (
        <main className="MyPage">
            <p><img src='dot.png' /> 내가 쓴 공고문</p>
            <div className="myitem">
                {value.map((item, i) => (
                    <MyItem item={item} key={i} index={i}></MyItem>
                ))}
            </div>
            <p><img src='dot.png' /> 전공 수정하기</p>
            <div>
